...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--source', type=str, default='D:\\yolov6\\custom_dataset', help='the source path, e.g. image-file/dir.')
    parser.add_argument('--yaml', type=str, default='D:\\yolov6\\YOLOv6-main\\data\\dataset.yaml', help='data yaml file.')
    ...
    parser.add_argument('--name', default='kitti', help='save inference results to project/name.')
...
def run(weights=osp.join(ROOT, 'yolov6s.pt'),
        source='D:\\yolov6\\custom_dataset\\images',
        yaml='D:/yolov6/YOLOv6-main/data/dataset.yaml',
        img_size=1382*512,
        conf_thres=0.25,
        iou_thres=0.45,
        max_det=1000,
