...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data-path', default='D:/yolov6/custom_dataset', type=str, help='path of dataset')
    parser.add_argument('--conf-file', default='./configs/yolov6s.py', type=str, help='experiments description file')
    parser.add_argument('--img-size', type=int, default=1382*512, help='train, val image size (pixels)')
